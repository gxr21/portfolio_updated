...
function Maintenance() {
  ...
  return <main className="relative flex min-h-screen items-center overflow-hidden bg-surface px-4 py-12" dir={direction}>
    ...
    <section className="relative mx-auto w-full max-w-2xl rounded-[2rem] border border-border bg-card/85 px-6 py-12 text-center shadow-xl backdrop-blur sm:px-12 sm:py-16">
    ...
    <p className="mt-8 text-sm font-bold tracking-wide text-primary">
      ...
      <h1 className="mt-3 text-3xl font-bold text-text-heading sm:text-4xl">
        {t.maintenance.title}
        </h1>
        <p className="mx-auto mt-5 max-w-lg text-lg leading-8 text-text-body">
          {t.maintenance.text}
          </p>
           <div className="mx-auto mt-9 max-w-sm rounded-xl border border-border bg-surface-bright px-5 py-4 text-sm text-text-body">
